...
ALTER TABLE crimes
  ADD  DEFAULT 'U' FOR classification;
ALTER TABLE crimes
...
ALTER TABLE criminals
  ALTER COLUMN criminal_id int NOT NULL;
  ALTER TABLE criminals
...
ALTER TABLE criminals
  ...
  ALTER TABLE aliases
  ALTER COLUMN alias_id INT NOT NULL;
ALTER TABLE aliases
...
ALTER TABLE aliases
  ALTER COLUMN criminal_id INT NOT NULL;
ALTER TABLE crimes
ALTER COLUMN crime_id INT NOT NULL;
ALTER TABLE crimes
...
ALTER COLUMN officer_id INT NOT NULL;
ALTER TABLE officers
...
ALTER COLUMN crime_code INT NOT NULL;
ALTER TABLE crime_codes
